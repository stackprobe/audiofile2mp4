...
　8. 画像ファイルを、ウィンドウの中央あたりにドラッグアンドドロップして下さい。
...
　　ファイルのエンコーディングは US-ASCII, 改行コードは LF 又は CR-LF です。
